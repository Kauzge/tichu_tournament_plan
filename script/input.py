...
def get_input():
    ...
    parser = argparse.ArgumentParser(description="This script to creates a Tichu tournament\
                                      plan with a given number of players and rounds")
    ...
    parser.add_argument('-t', '--terminal', action='store_true', default=False,
                        help='Set this flag to print the tournament plan to the terminal')
